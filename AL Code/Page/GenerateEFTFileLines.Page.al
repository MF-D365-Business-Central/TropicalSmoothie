page 60017 "MFCC01Generate EFT File Lines"
{
    Caption = 'Lines';
    DeleteAllowed = false;
    InsertAllowed = false;
    ...
    procedure Set(BankAccountNumber: Code[20]; Journalbatch: Code[10])
    var
    ...
    begin
        ...
        EFTExport.SetRange("Journal Batch Name", Journalbatch);
