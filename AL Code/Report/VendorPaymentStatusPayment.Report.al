report 60018 "Payment register by Invoices"
{
    ...
    begin
        If not VendEntry.Get(TempAppliedDtldVendLedgEntry."Vendor Ledger Entry No.") then
            Clear(VendEntry);

        VendEntry.CalcFields("Original Amount", "Remaining Amount", Amount);
        ExcelBuffer.NewRow();
        //Value: Variant, IsFormula: Boolean, CommentText: Text, IsBold: Boolean, IsItalics: Boolean, 
        //IsUnderline: Boolean, NumFormat: Text[30], CellType: Option
        ExcelBuffer.AddColumn(VendEntry."Posting Date", false, '', False, false, false, '', ExcelBuffer."Cell Type"::Date);
        ...
        ExcelBuffer.AddColumn(VendEntry."Document No.", false, '', False, false, false, '', ExcelBuffer."Cell Type"::Text);
        ExcelBuffer.AddColumn(VendEntry."Document Type", false, '', False, false, false, '', ExcelBuffer."Cell Type"::Text);
        ExcelBuffer.AddColumn(VendEntry."Payment method code", false, '', False, false, false, '', ExcelBuffer."Cell Type"::Text);
        ExcelBuffer.AddColumn(VendEntry."External Document No.", false, '', False, false, false, '', ExcelBuffer."Cell Type"::Text);
        ExcelBuffer.AddColumn(VendEntry."Document Date", false, '', False, false, false, '', ExcelBuffer."Cell Type"::Date);
        ExcelBuffer.AddColumn(VendEntry."Due Date", false, '', False, false, false, '', ExcelBuffer."Cell Type"::Date);

        ExcelBuffer.AddColumn(-(VendEntry."Original Amount"), false, '', False, false, false, '#,##0.00', ExcelBuffer."Cell Type"::Number);
        ExcelBuffer.AddColumn(-(VendEntry."Remaining Amount"), false, '', False, false, false, '#,##0.00', ExcelBuffer."Cell Type"::Number);
