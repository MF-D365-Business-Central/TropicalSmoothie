...
report 60015 "ExportElecPayments - Word(MFC)"
{
    Caption = 'Export Electronic Payments (MFC)';
        ...
        dataitem("Gen. Journal Line"; "Gen. Journal Line")
        {
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    column(SettleDate; Format("Gen. Journal Line"."Document Date", 0, '<Month,2>/<Day,2>/<Year4>'))
                    {
                    }
                    column(PostingDate; Format("Gen. Journal Line"."Posting Date", 0, '<Month,2>/<Day,2>/<Year4>'))
                    {
                    }
                    column(ExportAmount; Format(-ExportAmount))
                    {
                    }
                    ...
                    column(VendLedgEntry__Document_Date_; Format(VendLedgEntry."Document Date", 0, '<Month,2>/<Day,2>/<Year4>'))
                    {
                    }
                    ...
                    column(Posting_Date_Cap; '  Posting Date')
                    { }
                    ...
                    dataitem(PrintCompanyAddress; "Integer")
                    {
                        ...
                        column(Email_; 'tscinvoice@tropicalsmoothiecafe.com')
                        { }
                    ...
                    dataitem("Cust. Ledger Entry"; "Cust. Ledger Entry")
                    {
                        ...
                        column(Cust__Ledger_Entry__Document_Date_; Format("Document Date", 0, '<Month,2>/<Day,2>/<Year4>'))
                        {
                        }
                        column(Customer_Posting_Group_Ledger_Entry_Posting_Date; Format("Gen. Journal Line"."Posting Date", 0, '<Month,2>/<Day,2>/<Year4>'))
                        { }
                    ...
                    dataitem("Vendor Ledger Entry"; "Vendor Ledger Entry")
                    {
                        ...
                        column(Vendor_Ledger_Entry__Document_Date_; Format("Document Date", 0, '<Month,2>/<Day,2>/<Year4>'))
                        {
                        }
                        column(Remaining_Amt___LCY___Control36; -"Remaining Amt. (LCY)")
                        {
                        }
                        column(Vend_Ledger_Entry_Posting_Date; Format("Gen. Journal Line"."Posting Date", 0, '<Month,2>/<Day,2>/<Year4>'))
                        { }
                    ...
                    dataitem(CustomerInfo; "Integer")
                    {
                        ...
                        column(Cust_Posting_Date; Format("Gen. Journal Line"."Posting Date", 0, '<Month,2>/<Day,2>/<Year4>'))
                        { }
                        column(Cust_Document_Date; Format(CustLedgEntry."Document Date", 0, '<Month,2>/<Day,2>/<Year4>'))
                        {
                        }
                    ...
                    dataitem(VendorInfo; "Integer")
                    {
                        ...
                        column(Vend_Document_Date; Format(VendLedgEntry."Document Date", 0, '<Month,2>/<Day,2>/<Year4>'))
                        {
                        }
                        column(Vend_Posting_Date; Format("Gen. Journal Line"."Posting Date", 0, '<Month,2>/<Day,2>/<Year4>'))
                        { }
